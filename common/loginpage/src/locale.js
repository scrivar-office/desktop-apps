...
var l10n = l10n || {};
l10n.en = {
    welWelcome: 'Welcome to Scrivar Office',
    welDescr: 'Create and edit documents, spreadsheets, presentations, forms and PDFs — fully offline.',
    welNeedHelp: 'Need help? Visit our $1.',
    textHelpCenter: 'Help Center',
    btnConnect: 'Connect now',
    textHavePortal: 'Already use a cloud?',
    btnCreatePortal: 'Create an Scrivar Office cloud',
    ...
    portalEmptyAdv1: 'Don\'t have a cloud account yet? Go online with Scrivar Cloud and <br />try collaborative capabilities for free.',
    ...
    linkCreatePortal: 'Create an Scrivar Office cloud',
    linkResend: 'Send the code again',
    linkChangePhone: 'Change phone number',
    loginTitleStart: 'Connect to Scrivar Cloud',
    ...
    loginNoteAssignPhone: 'The two-factor authentication is enabled to provide additional Scrivar Office cloud security. Enter your mobile phone number to continue work on the cloud office. Mobile phone number must be entered using an international format with country code.',
    ...
    emptySlide3Text: 'Store your documents in the Scrivar Office cloud and access them any time, from anywhere.',
