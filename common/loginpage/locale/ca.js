l10n.ca = {
    welWelcome: 'Benvingut/da a Scrivar Office!',
    welDescr: 'Treballa sense connexió als teus documents o connecta la suite al teu núvol: Scrivar Office, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Crea un núvol Scrivar Office',
    ...
    portalEmptyAdv1: 'Encara no tens un compte de núvol? Entra en línia amb Scrivar Office Cloud Service i<br />prova les capacitats col·laboratives de franc.',
    ...
    linkCreatePortal: 'Crea un núvol Scrivar Office',
    ...
    emptySlide3Text: 'Emmagatzema els teus documents al núvol Scrivar Office i accedeix-hi en qualsevol moment, des de qualsevol lloc.',
