l10n.pt_BR = {
    welWelcome: 'Bem-vindo ao Scrivar Office!',
    welDescr: 'Trabalhe em documentos offline ou conecte-se à sua nuvem: Scrivar Office, ownCloud, Nextcloud.',
    welNeedHelp: 'Precisa de ajuda? Visite nossa $1.',
    textHelpCenter: 'Central de Ajuda',
    btnConnect: 'Conectar',
    textHavePortal: 'Já usa o nuvem?',
    btnCreatePortal: 'Criar Scrivar Office na nuvem',
    ...
    portalEmptyAdv1: 'Ainda não tem uma conta? Experimente colaboracão na nuvem do Scrivar Office gratuitamente.',
    ...
    linkCreatePortal: 'Criar Scrivar Office na nuvem',
    ...
    loginNoteAssignPhone: 'A autenticação de dois fatores está habilitada para fornecer segurança adicional ao nuvem do Scrivar Office. Insira o seu número de celular para continuar trabalhando no escritório na nuvem. O número de telefone deve ser inserido usando um formato internacional com o código do país.',
    ...
    emptySlide3Text: 'Armazene seus documentos na nuvem do Scrivar Office e acesse-os a qualquer momento, de qualquer lugar.',
