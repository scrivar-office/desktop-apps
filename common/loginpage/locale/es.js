l10n.es = {
    welWelcome: '¡Bienvenido a Scrivar Office!',
    welDescr: 'Trabaje en documentos «offline» o conecte la suite a su nube: Scrivar Office, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Crear cuenta de Scrivar Office en la nube',
    ...
    portalEmptyAdv1: '¿Todavía no tiene su cuenta en la nube? Conéctese en línea con el Servicio de Scrivar Office en la nube y pruebe sus prestaciones de colaboración gratis.',
    ...
    linkCreatePortal: 'Crear Scrivar Office en la nube',
    ...
    emptySlide3Text: 'Almacene sus documentos en la nube de Scrivar Office y acceda en cualquier momento y desde cualquier lugar.',
    ...
    actCloudAI: 'Nube e IA',
    actHelpContact: 'Ayuda y contacto',
    ...
    updUpdateTo: 'Actualizar a',
    updDownloading: 'Descargando',
    updRestart: 'Reiniciar para actualizar',
    updFailed: 'Error al actualizar — reintentar',
    updUpToDate: 'Actualizado',
}
