l10n.el = {
    welWelcome: 'Καλώς ήλθατε στο Scrivar Office!',
    welDescr: 'Εργαστείτε εκτός σύνδεσης με έγγραφα ή συνδέστε τη σουίτα στο cloud σας: Scrivar Office, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Δημιουργήστε ένα Scrivar Office cloud',
    ...
    portalEmptyAdv1: 'Δεν έχετε λογαριασμό cloud; Συνδεθείτε στο διαδίκτυο με την υπηρεσία Scrivar Office Cloud και <br /> δοκιμάστε τις δυνατότητες συνεργασίας δωρεάν.',
    ...
    linkCreatePortal: 'Δημιουργία ενός Scrivar Office cloud',
    ...
    emptySlide3Text: 'Αποθηκεύστε τα έγγραφά σας στο Scrivar Office cloud και αποκτήστε πρόσβαση σε αυτά ανά πάσα στιγμή και από οπουδήποτε.',
