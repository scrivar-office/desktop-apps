l10n.hy = {
    welWelcome: 'Բարի գալուստ Scrivar Office աշխատանքային սեղանի խմբագրիչներ',
    welDescr: 'Աշխատեք փաստաթղթերի վրա օֆֆլայն կամ միացրեք Ձեր փաթեթը Ձեր ամպին՝ Scrivar Office, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Ստեղծել Scrivar Office ամպ',
    ...
    portalEmptyAdv1: 'Դեռևս չունե՞ք ամպային հաշիվ։ Դարձեք առցանց Scrivar Office ամպային ծառայության հետ և <br />անվճար փորձեք համագործակցային հնարավորությունները։',
    ...
    linkCreatePortal: 'Ստեղծել Scrivar Office ամպ',
    ...
    loginNoteAssignPhone: 'Երկու գործոնով վավերացումն միացված է, որպեսզի ապահովվի Scrivar Office ամպի լրացուցիչ անվտանգություն։ Մուտքագրեք Ձեր հեռախոսահամարը, որպեսզի շարունակեք աշխատել ամպային office-ում։ Հեռախոսահամարը պետք է մուտքագրվի երկրի կոդով՝ ըստ միջազգային ֆորմատի։',
    ...
    emptySlide3Text: 'Պահպանեք Ձեր փաստաթղթերը Scrivar Office ամպում, և դրանք հասանելի կլինի ցանկացած պահի ցանկացած վայրից։',
