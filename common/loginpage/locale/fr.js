l10n.fr = {
    welWelcome: 'Bienvenue sur Scrivar Office !',
    welDescr: 'Travaillez avec vos documents en mode hors-connexion ou connectez la suite à votre Cloud : Scrivar Office, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Créer un compte Cloud Scrivar Office',
    ...
    portalEmptyAdv1: 'Vous n\'avez pas encore de compte Cloud ? Accéder en ligne avec Scrivar Cloud et essayez les capacités de gestion collaborative gratuitement.',
    ...
    linkCreatePortal: 'Créer un compte Cloud Scrivar Office',
    ...
    emptySlide3Text: 'Stockez vos documents dans Scrivar Office Cloud et accedez-y depuis n\'importe où et à n\'importe quel moment.',
    ...
    actCloudAI: 'Cloud et IA',
    actHelpContact: 'Aide et contact',
    ...
    updUpdateTo: 'Mettre à jour vers',
    updDownloading: 'Téléchargement',
    updRestart: 'Redémarrer pour mettre à jour',
    updFailed: 'Échec de la mise à jour — réessayer',
    updUpToDate: 'À jour',
}
