l10n.be = {
    welWelcome: 'Вітаем у Scrivar Office!',
    welDescr: 'Працуйце з дакументамі ў аўтаномным рэжыме або падлучыцеся да воблака: Scrivar Office, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Стварыць воблака Scrivar Office',
    ...
    portalEmptyAdv1: 'У вас яшчэ няма воблачнага акаўнта? Перайдзіце на сеціўны рэжым працы з дапамогай Scrivar Office Cloud Service і <br/> бясплатна азнаёмцеся з магчымасцямі сумеснай працы.',
    ...
    linkCreatePortal: 'Стварыць воблака Scrivar Office',
    ...
    pshCode: 'код з SMS',
    loginNoteAssignPhone: 'Каб забяспечыць дадатковую бяспеку Scrivar Office, уключаная двухфактарная аўтэнтыфікацыя. Каб працягнуць працу ў воблачным офісе, увядзіце нумар мабільнага тэлефона. Нумар мабільнага тэлефона павінен быць уведзены ў міжнародным фармаце з кодам краіны.',
    ...
    emptySlide3Text: 'Захоўвайце свае дакументы ў воблаку Scrivar Office і працуйце з імі ў любы час з любога месца.',
