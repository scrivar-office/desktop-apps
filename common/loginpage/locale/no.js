l10n.no = {
    welWelcome: 'Velkommen til Scrivar Office redigeringsprogrammer for PC!',
    welDescr: 'Arbeid med dokumenter offline eller koble suiten til din skykonto: Scrivar Office, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Lag en Scrivar Office-sky',
    ...
    portalEmptyAdv1: 'Har du ikke konto enda? Koble deg til nettet med Scrivar Office skytjeneste og <br />prøv samarbeidsfunksjonene gratis.',
    ...
    linkCreatePortal: 'Sett opp en Scrivar Office-sky',
    ...
    loginNoteAssignPhone: 'To-faktor-godkjenning er aktivert for å gi ekstra skysikkerhet for Scrivar Office. Skriv inn mobilnummeret ditt for å fortsette å arbeide på skykontoret. Mobiltnummer må angis med et internasjonalt format med landskode.',
    ...
    emptySlide3Text: 'Lagre dokumentene dine i Scrivar Office-skyen og få tilgang til dem når som helst, fra hvor som helst.',
